...
.kn-icon-btn {
  ...
  border: 0; background: transparent; color: #e8e8e8; border-radius: 999px;
...
.kn-empty-icon { width: 46px; height: 46px; color: rgba(232,232,232,0.32); }
...
.kn-card {
  background: #262626; border-radius: 18px; padding: 14px 16px 8px;
  animation: kn-rise 320ms cubic-bezier(0.16,1,0.3,1) both;
}
...
.kn-card-foot {
  ...
  padding: 10px 0 8px; border-top: 1px solid rgba(255,255,255,0.07);
}
.kn-status {
  display: inline-flex; align-items: center; gap: 7px;
  border: 0; background: transparent; padding: 0;
  font: inherit; font-size: 14px; color: rgba(232,232,232,0.45); cursor: pointer;
}
.kn-status.is-on { color: #3b82f6; }
...
.kn-save {
  border: 0; background: transparent; color: #e8e8e8;
...
.kn-input {
  ...
  background: #2b2b2b; border: 1px solid transparent; border-radius: 14px;
  padding: 14px 16px; color: #e8e8e8; font: inherit; font-size: 15px;
  outline: none; transition: border-color 160ms ease, background 160ms ease;
}
.kn-input::placeholder { color: rgba(232,232,232,0.35); }
.kn-input:focus { border-color: rgba(255,255,255,0.18); background: #303030; }
